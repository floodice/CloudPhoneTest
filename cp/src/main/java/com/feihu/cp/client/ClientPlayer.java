...
public class ClientPlayer {
    ...
    private void videoStreamIn() {
        ...
        try {
            ...
            if (useH265)
                videoDecode = new VideoDecode(clientController.getVideoSize(), clientController.getSurface(), csd0, null, playHandler);
            else
                videoDecode = new VideoDecode(clientController.getVideoSize(), clientController.getSurface(), csd0, clientStream.readFrameFromVideo(), playHandler);
